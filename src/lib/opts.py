...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--demo', default='D:/EfficientDet_PIAFusion/data/coco_rgb',  # D:/EfficientDet/data/kaist/yjh_kaist_coco_rgb
                                 help='path to image/ image folders/ video. '
                                      'or "webcam"')
        self.parser.add_argument('--load_model', default='E:\\Lab_code\\Detection_centernet\\models\\ctdet_coco_hg.pth',  # 수정 ~#../models/ctdet_coco_hg.pth   D:\\CenterNet_PIAFusion\\exp\\ctdet\\default\\model_last.pth
                                 help='path to pretrained model')   # D:\\CenterNet\\exp\\ctdet\\default\\model_last.pth
        ...
        self.parser.add_argument('--arch', default='hourglass',
                                 help='model architecture. Currently tested'
                                      ...
                                      'dlav0_34 | dla_34 | hourglass | bifpn_hourglass | bifpn_hourglass_Attention')
        ...
        self.parser.add_argument('--batch_size', type=int, default= 5,  # 5->12
                                 help='batch size')
    ...
    def parse(self, args=''):
        ...
        opt.num_stacks = 2 if opt.arch == 'hourglass' else 1 ## opt.num_stacks = 2
        ...
        opt.root_dir = "E:\\Lab_code\\Detection_centernet"

        opt.data_dir = "E:\\Lab_code\\Detection_centernet\\data"
    ...
    def init(self, args=''):
        default_dataset_info = {
            'ctdet': {'default_resolution': [512, 512], 'num_classes': 20,  # 수정 80-> 20
